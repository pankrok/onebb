 ...
 * @ApiResource( 
    ...
    itemOperations={
            "put_moderator"={
               ...
               "path"="/users/moderator/{id}",
               "method"="PUT",
               "denormalization_context"={"groups"={"moderator.put"}},
               "normalization_context"={"groups"={"moderator.put"}}
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    * @Groups({"moderator.put", "category", "board", "plot", "user", "admin_user_put"}) 
     */
    private $warn_lvl;
