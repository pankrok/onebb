...
<template>
  <button class="button button-color-primary position-relative" @click="searchModal = true">
    ...
    <PanelComponent header class="col-12">
      ...
      <div class="column-sm margin-sm-m">
        ...
        <div v-if="data" style="max-height: 600px; overflow-y: auto; overflow-x: hidden;">
          <div
            class="row margin-sm-s border-1 border-color-dark padding-sm-m"
