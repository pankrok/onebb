...
<template>
  <div class="col-2">
    <div class="column align-items-center padding-m font-size-10">
  ...
  <div class="col-auto height-12">
    <div class="column justify-content-space-between margin-m padding-x-l font-size-12 height-12">
      ...
      <div class="row justify-content-flex-end border-top-1 border-color-primary padding-y-s">
        <div>
          <button class="button button-color-blue">Cytuj</button>
