...
<template>
    <div class="row margin-m">
        ...
        <div class="col-2 row align-items-center">
            <span>
                <i class="fas fa-comments"></i> {{ plot.post_no }} / {{ plot.views }} <i class="fas fa-eye"></i>
            </span>
        </div>
        <div v-if="plot.last_active_user" class="col-2 row ">
            ...
            <div class="col-3 row align-items-center justify-content-flex-end">
                ...
                <Image :src="plot.last_active_user.avatar" :alt="plot.last_active_user.username" :size="[50, 50]" rounded />
